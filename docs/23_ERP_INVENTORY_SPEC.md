...
갱신일: 2026-06-10 · 소스: `server/src/routes/erp.ts`, `server/src/db/migrations/020~022`, `apps/web/src/app/(app)/erp/`
...
- 실제 동기화 어댑터는 미구현 — MES 사양 확보(~2026-08) 후 재설계 없이 붙일 수 있도록 스키마만 선반영
