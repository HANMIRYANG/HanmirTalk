...
import type { NoticeReadStatus } from "@hanmir/shared";
...
interface NoticeReadStatusButtonProps {
  noticeId: string;
}
...
export function NoticeReadStatusButton({ noticeId }: NoticeReadStatusButtonProps) {
  const router = useRouter();
  const [open, setOpen] = useState(false);
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<NoticeReadStatus | null>(null);
